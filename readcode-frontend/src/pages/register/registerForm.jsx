...
const RegisterForm = ({handleUserRegistration, loading}) => {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <Box display={"flex"} flexDirection={"column"} alignItems={"center"}> 
                ...
                <LoadingButton loading={loading} type="submit" variant="contained" sx={{width:"30vh"}}>S'ENREGISTRER</LoadingButton>
            </Box>
        </form>
    )
}
